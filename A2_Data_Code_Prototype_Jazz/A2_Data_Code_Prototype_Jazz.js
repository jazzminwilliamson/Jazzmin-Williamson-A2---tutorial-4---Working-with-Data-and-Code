...
textSize(30); 
textAlign(CENTER);
fill(229, 153, 37); // colour of title text
textFont('Larken Black');
text("The Ocean Remembers - Sydney's September Ocean Data 2020–2025", width / 2, 50); // title centered at the topp

// Rectangle for Legend
  fill(255);
  stroke (229, 153, 37);
  strokeWeight (2);
  rect(180, 110, 300, 90, 20); // rectangle dimensions = (x, y, width, height, curved corners);
...
textFont ('NHaasGroteskDSPro-65Md'); // text font from Processing library
fill(0, 200, 300);
textAlign(LEFT, CENTER); // align text on left side of screen for easy reading
text("🌡️Ocean Temperature", 40, 90); // position of text (x, y)
fill(41, 189, 214);
text("🌊 Wave Height - hold down mouse to view", 40, 110);
fill (0, 30, 193);
text("🦠 Bacteria Levels (/100) - double click to view", 40, 130);
